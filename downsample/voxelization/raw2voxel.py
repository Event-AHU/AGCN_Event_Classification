...
data_path = "/amax/DATA/yuanchengguo/celex_action_recognition/data/ASL/ASL_DVS"
save_path = "/amax/DATA/yuanchengguo/celex_action_recognition/data/ASL/ASL_voxel"
...
def transform_points_to_voxels(data_dict = {}, device = torch.device("cuda:0")):
    ...
    # voxels代表了每个生成的voxel数据
    # coordinates代表了每个生成的voxel所在的zyx轴坐标
    # num_points代表了每个生成的voxel中有多少个有效的点维度是[m,]
